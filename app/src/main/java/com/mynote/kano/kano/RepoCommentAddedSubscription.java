...
public final class RepoCommentAddedSubscription implements Subscription<RepoCommentAddedSubscription.Data, RepoCommentAddedSubscription.Data, RepoCommentAddedSubscription.Variables> {
  public static final String OPERATION_DEFINITION = "subscription RepoCommentAddedSubscription($repo: String!) {\n"
  ...
  public static final String OPERATION_ID = "920fc7ed01a3d73fcae9483f8adb97035255bc29db55bd883390db94c5583051";
  ...
  private final RepoCommentAddedSubscription.Variables variables;

  public RepoCommentAddedSubscription(@NotNull String repo) {
    Utils.checkNotNull(repo, "repo == null");
    variables = new RepoCommentAddedSubscription.Variables(repo);
  }
  ...
  @Override
  public RepoCommentAddedSubscription.Data wrapData(RepoCommentAddedSubscription.Data data) {
    return data;
  }

  @Override
  public RepoCommentAddedSubscription.Variables variables() {
    return variables;
  }
